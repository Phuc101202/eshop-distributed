namespace Catalog.Endpoints
{
    public static class ProductEndpoints
    {
        public static void MapProductEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            {
                var product = await service.GetProductsByIdAsync(id);
            ...
            {
                var updatedProduct = await service.GetProductsByIdAsync(id);
            ...
            {
                var deletedProduct = await service.GetProductsByIdAsync(id);
